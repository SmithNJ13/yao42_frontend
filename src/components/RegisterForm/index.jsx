      ...
      <div id='form-con' className='tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-m-auto tw-shadow-lg tw-shadow-gray-600 tw-border-none'>
        ...
        <form style= {{ backgroundImage: `url(${form})`}} className= 'poppins-font tw-bg-cover tw-w-full tw-mx-auto tw-px-[4rem]'>
          ...
          <div className='tw-flex tw-flex-col tw-py-1'>
            ...
            <input type='text' className='tw-border-2 tw-rounded-lg focus:tw-border-green-700 focus:tw-outline-none tw-border-gray-200 tw-p-[0.4rem] tw-text-sm'/>
          </div>
          <div className='tw-flex tw-flex-col tw-py-1'>
            <label>Email</label>
            <input type='email' className='tw-border-2 tw-rounded-lg focus:tw-border-green-700 focus:tw-outline-none tw-border-gray-200 tw-p-[0.4rem] tw-text-sm' />
          </div>
          <div className='tw-flex tw-flex-col tw-py-1'>
          ...
          <div className='tw-flex tw-flex-col tw-py-1'>
            ...
            <input type='text' className='tw-border-2 tw-rounded-lg focus:tw-border-green-700 focus:tw-outline-none tw-border-gray-200 tw-p-[0.4rem] tw-text-sm' placeholder='Please re-enter your password...' />
          </div>
